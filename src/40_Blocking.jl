...
* obs_multiple_for_new_block::Real - The relative number of ticks to seperate a new block. For instance 1.2 means make a new block when some asset has 20% more observations than another in that block.
* func::Symbol - A symbol representing the covariance estimation function to be used.
* optional_parameters::NamedTuple - Optional parameters to be used in the func function.
### Returns
...
### Takes
* ts::SortedDataFrame - The tick data.
* blocking_frame::DataFrame - A `DataFrame` representing what estimations to do and in what order. This is often be one generated by the `put_assets_into_blocks_by_trading_frequency` function (and potentially then modified).
### Returns
* A `CovarianceMatrix`.
"""
